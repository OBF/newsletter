_Having trouble viewing this email or looking for a permalink? [View this newsletter in your browser](https://github.com/OBF/newsletter/blob/master/newsletters/2018-07.md). Please note that on this occasion we've sent the email to the [bosc-announce](http://mailman.open-bio.org/mailman/listinfo/bosc-announce/), [open-bio-l](http://mailman.open-bio.org/mailman/listinfo/open-bio-l/), and [member lists](http://mailman.open-bio.org/mailman/listinfo/members/). Future mails will be sent only to bosc-announce and open-bio-l, so if you'd like to continue receiving newsletters, please subscribe to one or both of these lists. Note that they’re very low traffic and used exclusively (bosc-announce) or primarily (open-bio-l) for announcements only._
